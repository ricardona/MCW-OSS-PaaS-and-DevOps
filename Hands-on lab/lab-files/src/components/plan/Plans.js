            ...
            <div class="plan-wrapper">
              <div class="plan">
                ...
                <div class="plan-price">
                  ...
                  <Link to={'/order/' + plan._id} class="btn btn-warning">
                    Select this plan
                  </Link>
                </div>
              </div>
            ...
            <ul class="list">
              <li>
                <div class="text-container">
                  ...
                  <div class="text">
                    Our chefs create delicious, whole-foods-based recipes with 100% natural ingredients.
                  </div>
                </div>
              </li>
              <li>
                <div class="text-container">
                  ...
                  <div class="text">
                    Each week, we will send you a variety of meals, made up of fresh ingredients in the correct
                    portions.
                  </div>
                </div>
              </li>
              <li>
                <div class="text-container">
                  ...
                  <div class="text">
                    You will perform a little be of prep work, and cook unique, amazing meals that you’ll love.
                  </div>
                </div>
              </li>
            </ul>
